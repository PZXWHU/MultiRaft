...
import com.pzx.rpc.utils.ReflectUtil;
...
public abstract class AbstractRpcServer implements RpcServer {
    ...
    private final static Logger logger = LoggerFactory.getLogger(AbstractRpcServer.class);

    public void scanAndPublishServices() {
